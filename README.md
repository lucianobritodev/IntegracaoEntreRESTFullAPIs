# Integração Entre APIs RESTFull

## Descrição

Aplicação criada para ilustrar um cenário real onde é necessário criar integração entre sistemas ou microsserviços usando Rest. A aplicação foi desenvolvida em Java com SpringBoot, SpringDataJPA e persistência no SGBD Postgres.
